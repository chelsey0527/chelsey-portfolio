  ...
  return (
    <>
      ...
      <div className='normal-font margin-bottom-20'>
        ...
        <div>
        To improve efficiency and meet the growing demand for sneakers, the platform allows
        customers to place orders at any time, automating the process and reducing the workload on the startup
        </div>
        <div>Contribution:</div>
        <div>
        Responsible for all UI/UX design and front-end develop with HTML, CSS, EJS.<br/>
        ...
        <div>
        Our sneaker reselling platform has become popular in Taiwan because we seized
        the market demand, established matchmaking between retailers and buyers
        </div>
        <div>Learning & Reflection:</div>
        <div>
        Insight into market changes and execution are critical issues to a startup
        </div>
      </div>
